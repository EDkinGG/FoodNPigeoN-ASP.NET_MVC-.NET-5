...
namespace FoodPigeoN.Migrations
{
    ...
    [Migration("20220720073647_Identity_edited")]
    partial class Identity_edited
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodPigeoN.Models.AppUser", b =>
                {
            ...
            modelBuilder.Entity("FoodPigeoN.Models.ShoppingCartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FoodPigeoN.Models.Order", b =>
                {
                    b.HasOne("FoodPigeoN.Models.AppUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FoodPigeoN.Models.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
